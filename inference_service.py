...
from . import version
from alpr.detect import find_plate_bbox
from alpr.rectify import warp_plate
from alpr.segment import split_characters
from alpr.ocr_model import load_model, predict_chars
from alpr.postprocess import fix_confusions
...
def get_model():
    global _model
    if _model is None:
        _model = load_model()  # carga CNN real si hay pesos; si no, stub
    return _model
